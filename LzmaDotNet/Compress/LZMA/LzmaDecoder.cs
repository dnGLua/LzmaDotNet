using System;
using System.IO;
using LzmaDotNet.Compress.LZ;
using LzmaDotNet.Compress.RangeCoder;

namespace LzmaDotNet.Compress.LZMA
{
        ...
        // while(nowPos64 < next)
      {
        ...
        else
        {
          ...
          if (m_IsRepDecoders[state.Index].Decode(m_RangeDecoder) == 1)
          {
            ...
            {
              if (m_IsRep0LongDecoders[(state.Index << Base.kNumPosStatesBitsMax) + posState].Decode(m_RangeDecoder) ==
                  0)
              {
